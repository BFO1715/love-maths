...
function checkAnswer() {
    ...
    if (isCorrect) {
        alert("Suprising! You got it right.");
        incrementScore()
    } else {
        alert(`You suck! You answered ${userAnswer}. The correct answer was ${calculatedAnswer [0]}`);
...
/**
 * Gets the operands (numbers) and the operator (calc) directly
